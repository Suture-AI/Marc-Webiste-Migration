...
export default {
  ...
  sub: "An accusation alone can threaten your reputation, your career and your freedom — Marc Kohnen defends all three with discretion and tenacity.",
  sections: [
    {
      paras: [
        ...
        "So, if you are facing sexual charges, you need to consult a skilled attorney who knows the intricacies of the law. Working with an experienced criminal lawyer in San Diego can make a crucial difference in the outcome of your case.",
    ...
    {
      h2: "Have You Been Wrongly Accused of a Sex Crime?",
      paras: [
        "The Californian courtrooms see numerous cases every day with the wrong person being accused of sexual crimes. These allegations are often exaggerated and even completely fabricated. This can happen due to a vindictive strategy to take revenge on the other side.",
    ...
    {
      h2: "Types of Sex Crimes We Deal With",
      paras: [
    ...
    {
      h2: "What Is the Legal Process of Sex Crimes?",
      paras: [
    ...
    {
      h2: "Looking for the Best Sexual Harassment Attorneys in San Diego?",
      paras: [
        "It's hard enough to deal with a sex offense, knowing you're innocent. Such charges call for the best defense. But not knowing who to hire can leave you stranded in the middle of the road. That's where you can trust The Law Office of Marc S. Kohnen to become your voice in court.",
    ...
    {
      h2: "Book a Confidential Consultation with Marc Kohnen",
      paras: [
