...
export default {
  ...
  sections: [
    {
      h2: "Outstanding Warrants Attorney in San Diego",
      paras: [
    ...
    },
    {
      ...
      paras: [
        ...
        "Here, hiring an experienced criminal defense attorney can work in your favor. Marc Kohnen offers personalized services to protect your rights. Not only can Marc advocate your case before the judge, but he also fights to reduce your bail. Owing to his experience and your good reputation, you can even be released on your own recognizance.",
        "So, how does Marc do that? Marc is well in-depth with California law. That's why he presents valuable evidence before the court that helps in retaining your freedom. Marc uses his special negotiation skills to seek leniency from the judge, too. Ultimately, you can avoid severe consequences without visiting the court more than once.",
      ],
      image: {
        src: "/assets/photos/marc-kohnen-courthouse-press-conference-03.jpg",
        alt: "San Diego criminal defense attorney Marc Kohnen addressing the press outside a San Diego courthouse",
        caption: "Marc Kohnen addressing press outside the San Diego courthouse",
      },
    },
    {
