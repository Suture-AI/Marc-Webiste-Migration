/* New content module — Drug Diversion under Penal Code §1000.
   Child of the Diversion Programs hub. */
export default {
  key: "drug-diversion",
  metaTitle: "San Diego PC 1000 Drug Diversion Lawyer - Marc Kohnen",
  metaDescription:
    "Facing a drug possession charge in San Diego? PC 1000 pretrial diversion can end the case with a dismissal and a sealed arrest. Free consultation.",
  h1: "San Diego Drug Diversion Attorney — Penal Code §1000",
  sub: "For qualifying drug possession charges, PC 1000 trades a conviction for treatment — finish the program and the case is dismissed.",
  sections: [
    {
      paras: [
    ...
    {
      h2: "How PC 1000 Pretrial Diversion Works",
      paras: [
    ...
    {
      h2: "Eligibility: Who Gets In and Who Doesn't",
      paras: [
    ...
    {
      h2: "What the 12-to-18-Month Program Looks Like",
      paras: [
    ...
    {
      h2: "Finishing the Program — and What Happens If You Don't",
      paras: [
    ...
    {
      h2: "PC 1000 vs. Prop 36 vs. Mental Health Diversion",
      paras: [
    ...
    {
      h2: "Start Before Your First Court Date",
      paras: [
