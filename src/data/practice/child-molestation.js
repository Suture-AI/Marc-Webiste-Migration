/* Copy migrated verbatim (lightly proofed) from msklawyer.com/sex-crimes/child-molestation/ —
   expanded with PC 288 statute, penalty, investigation and San Diego court-process sections. */
export default {
  key: "child-molestation",
  metaTitle: "San Diego Child Molestation Defense Lawyer | Marc Kohnen",
  metaDescription:
    "Accused of lewd acts under PC 288 in San Diego? Marc S. Kohnen defends child molestation cases with outcomes that included no jail and no registration.",
  h1: "San Diego Child Molestation Defense Lawyer",
  sub: "False accusations destroy lives — Marc Kohnen builds the meticulous, private defense yours demands.",
  sections: [
    {
      paras: [
    ...
    {
      h2: "What Penal Code 288 Actually Covers",
      paras: [
    ...
    {
      h2: "Sentencing Exposure and What Is Really at Stake",
      paras: [
    ...
    {
      h2: "Why Innocent People Get Accused",
      paras: [
    ...
    {
      h2: "The Investigation Usually Starts Before You Know About It",
      paras: [
    ...
    {
      h2: "How These Cases Move Through San Diego County Courts",
      paras: [
    ...
    {
      h2: "What Marc Has Done in Cases Like This",
      paras: [
