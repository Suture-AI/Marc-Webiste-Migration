...
export default {
  ...
  sub: "Violent-crime allegations carry the harshest penalties in California — Marc meets them with the hardest-hitting defense.",
  sections: [
    {
      paras: [
        "California law is strict when it's about upholding justice. That's why conviction for committing a violent crime can lead to severe implications, such as serving long-term prison time.",
    ...
    {
      h2: "What Are the Different Types of Violent Crimes?",
      paras: [
        "Any criminal act that causes injury to another human, physically or verbally, is considered a violent crime.",
        "Six major crimes are considered violent in California. These include rape, murder, assault, domestic violence, robbery, and kidnapping. If proven guilty of committing any of these crimes, you can end up serving jail or prison time and heavy fines. Not only will you have to bear the consequences, but you will also lose certain life benefits, such as employment opportunities or owning a weapon.",
      ...
      image: {
        src: "/assets/press/marc-kohnen-nbc7-hells-angels-sentencing.jpg",
        alt: "San Diego violent crimes defense attorney Marc Kohnen on NBC San Diego covering a violent-crime sentencing",
        caption: "Marc Kohnen on NBC San Diego during violent-crime sentencing coverage",
      },
    },
    {
      h2: "Rape Charges",
      paras: [
        ...
        "Given that there is enough evidence, the outcome can turn against you, with you having to register as a sex offender for life. But that's where we can help you reduce the jail sentence or even achieve case dismissal by creating a solid defense strategy.",
    ...
    },
    {
      ...
      paras: [
        ...
        "In most cases, it can be hard for the victim to drop the charges as the prosecution can move forward with the case. If convicted, it can lead to significant jail time.",
        ...
        "In other cases, we've helped reduce a felony charge to a misdemeanor, too. And the list of cases where we got the charges dismissed completely is also in glowing numbers.",
      ],
    },
    {
      h2: "Robbery",
      paras: [
        "Robbery can often be mistaken for theft, but there's a significant difference. A robbery involves seizing someone else's property directly in their presence or absence against their will by using physical force or verbal threats.",
        "Often, it leads to bodily harm. Hence it comes under the violent crimes category.",
        "Being charged with robbery can lead to grave circumstances with heavy fines and prison time. And that's why it's always a good option to immediately consult legal counsel who knows the inner workings of the San Diego courtrooms.",
      ],
    },
    {
      h2: "Kidnapping",
      paras: [
        ...
        "These factors and more are what we evaluate deeply to help you navigate through complicated California law. But above all, we have your best interest at heart.",
      ],
    },
    {
      h2: "Hire a Professional San Diego Violent Crimes Attorney",
      paras: [
        ...
        "If you're facing a violent crime charge, don't hesitate to reach us at The Law Office of Marc S. Kohnen today.",
      ],
    },
  ],
};
